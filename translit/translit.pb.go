...
// source: translitMicroService.proto

/*
Package translitMicroService is a generated protocol buffer package.

It is generated from these files:
	translitMicroService.proto
...
func init() {
	proto.RegisterType((*Word)(nil), "translitMicroService.Word")
}
...
func (c *transliterationClient) EnRu(ctx context.Context, opts ...grpc.CallOption) (Transliteration_EnRuClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Transliteration_serviceDesc.Streams[0], c.cc, "/translitMicroService.Transliteration/EnRu", opts...)
	if err != nil {
		return nil, err
	}
...
var _Transliteration_serviceDesc = grpc.ServiceDesc{
	ServiceName: "translitMicroService.Transliteration",
	...
	Metadata: "translitMicroService.proto",
}

func init() { proto.RegisterFile("translitMicroService.proto", fileDescriptor0) }
